...
- 股價請求節流：批次 **更新股價** 會短暫沿用剛取得的報價且不跨過 13:40；13:40 後允許再抓一次收盤價。單筆編輯裡的 **抓現價** 會強制重新查詢，方便修正單檔價格。
...
- 股票：用 `資產 / 股票市值`，輸入股票代號與股數。交易日盤中（09:00–13:30）可抓即時價；13:40 後可更新當日收盤價。批次 **更新股價** 會略過仍在有效期間內的報價；單筆 **抓現價** 會強制重新查詢。
